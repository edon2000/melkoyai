...
psql "postgresql://postgres.hlyhuteksgmyovgztfhf:1astigmastism1@a@aws-1-eu-central-1.pooler.supabase.com:5432/postgres?sslmode=require" -f supabase-schema.sql
```
